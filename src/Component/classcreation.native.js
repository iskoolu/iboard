...
import { Image, Switch, TouchableOpacity, ScrollView, View, StyleSheet, Text, BackHandler, FlatList } from 'react-native';
...
export default class classcreation extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      singleFile: '',
      fromdate_value: '', validate_greaterdate: true, errorvalidateDate: '',
      from_edit: false,
      todate_value: '',
      noOfDays: '',
      whichdate: '',
      ...
      array_heading: [],
      radiossesment: false,
      toggleassignment: false, send_assign: null,
      assesment_toggle: false, send_assesment: null,
      download_toggle: false, send_download: null,
      recording_toggle: false, send_record: null,
      authorization: '',certificate_url:null,course_url:null, error_show_msg:'',
      error_showvalue:true,

      error_show_certificate:'',
      error_showvalue__certificate:true,
    };
  ...
  submitAllDetails = (value_store) => {
    ...
    let payload = {
      ...
      "content": {"title": value_store.courseTitle, 
                ...
                "tableOfContents":this.state.array_heading},
      ...
      "ratePerSession": (value_store.rateperCourse / value_store.noofClass),
    ...
    let self = this;
    console.log("send",this.state.array_heading);
      ...
      if (response.didCancel) {
        ...
        if( filesize < 500000){
          ...
          if (type == "course") {
            ...
            this.setState({error_showvalue__certificate:true})
          ...
          if (type == "course") {
            ...
            this.setState({error_showvalue__certificate:false})
            this.setState({error_show_msg: LABELCONSTANT.EditProfile.photo_size})
  ...
  timeslotFunction = (data_from_child) => {
    ...
    if (this.state.datasend_timeslot == '') {
      ...
      if(data_from_child == "back"){

        console.log(data_from_child)
        this.state.array_timeslot
      }
      else{
  ...
  headingFunction = (data_from_child) => {
    ...
    console.log(JSON.stringify(data_from_child));
  ...
  preview = (value_store) => {
    ...
    let payload = {
      "userId": "199",
      "courseName": value_store.courseTitle,
      "courseKeyword": value_store.courseKeyword,
      "content": {
        "description": value_store.description
      },
      ...
      "noOfParticipant": value_store.participants,
      "demoUrl": value_store.demoVideolink,
      "fromDate": this.state.fromdate_value,
      "toDate": this.state.todate_value,
      "courseDuration": this.state.noOfDays,
      "downloadAllow": this.state.send_download,
      "assignAvailable": this.state.send_assign,
      "testAvailable": this.state.send_assesment,
      "slots": this.state.array_timeslot,
      "courseUrl": this.state.course_url,
      "certificationUrl": this.state.certificate_url,
    };
            ...
            {({ values, handleChange, errors, setFieldTouched, touched, isValid, handleSubmit }) => (
              <View style={styles.textviewstyle}>
                ...
                <TextInput
                  ...
                  // onFocus={() =>this.checkonfocus("course") }
                  // onChangeText = {coursename => this.onsubjectText(coursename)}
                ...
                {this.state.coursenamevalidate == false || this.state.isFocused == false ? (
                  <Text style={styles.errorMessage}>
                    {this.state.error_coursename}
                  </Text>
                ) : null}
                ...
                {this.state.show_flatlist == false ? (
                  <View>
                    <View style={{
                ...
                { this.state.error_showvalue__certificate == false?(this.renderWarning()):null}

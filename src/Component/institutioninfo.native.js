...
import { INSTI_POST_ADDINFO, BASE_URL_LOGIN,POST_UPDATE_IMAGE,
         PINCODE_API,GET_USER_DETAILS } from '../services/api.constans';
...
export default class institutioninfo extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      interested_value: '',
      PickerSelectedVal: '',
      currentdate: currentDate, ImageSource: null,image_send:'',image_sendURL:'',
      textLength: 0,show_modal:false,
    ...
    this.authtoken_fun()
    var chooname = '';
    AsyncStorage.getItem('Choose').then(value => {
      this.setState({ chooname: value });
    }
    );
...
<View style={{flex: 0.5, backgroundColor: "#fff" ,
        ...
        <ScrollView style={styles.scrollView}>
          ...
          <TextInput
            style={{
              flex: 3, margin: 15, height: 80, borderColor: 'white', borderWidth: 1,
              backgroundColor: '#f5f5f5', borderRadius: 4,
            }}
            placeholder={LABELCONSTANT.LBL_WELCOME.ABOUT_INSTITUTION}
          ...
          <View style={{
            ...
            <DatePicker
              ...
              placeholder={LABELCONSTANT.LBL_WELCOME.DATE_ESTABLISH}
              format="DD-MM-YYYY"
          ...
          <TextInput
            style={styles.inputStyle}
            placeholder={LABELCONSTANT.LBL_WELCOME.DOMAIN_EXPERT}
